...
const FALLBACK_SLIDES: HeroSlide[] = [
    {
        ...
        subtitle: 'منتجات عالية الجودة بأفضل الأسعار',
        description: 'تسوق الآن واحصل على خصم يصل إلى 50% على مختارات مميزة',
...
export default function OptimizedHeroSection({ slides }: OptimizedHeroSectionProps) {
                        ...
                        <div className="max-w-4xl">
                            ...
                            {currentSlideData.discountPercentage && (
                                <Badge className="mb-4 sm:mb-6 bg-gradient-to-r from-red-500 to-red-600 text-white text-sm sm:text-lg px-4 py-2 sm:px-6 sm:py-3 rounded-full shadow-lg animate-pulse">
                                    ...
                                    عرض حصري - خصم {currentSlideData.discountPercentage}%
                                </Badge>
                            )}

                            {/* Enhanced main headline - Mobile First Typography */}
                            ...
                            {/* Enhanced subtitle - Mobile First */}
