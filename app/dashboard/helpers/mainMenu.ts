...
export const menuGroups = [
  ...
  },
  {
    ...
    items: [
      { title: 'المخزون', url: '/dashboard/products-control', icon: Package }, // Changed to "Inventory"
      { title: 'التصنيفات', url: '/dashboard/categories', icon: Tags }, // Changed icon
      { title: 'إدارة الموردين', url: '/dashboard/suppliers', icon: Warehouse },
    ],
  },
  {
    label: 'إدارة العملاء',
    items: [
      { title: 'سجل العملاء', url: '/dashboard/user-mangment/customer', icon: Users },
  ...
  },
  {
    label: 'إدارة الفريق',
    items: [
      { title: 'المشرفون', url: '/dashboard/user-mangment/admin', icon: ShieldCheck }, // Changed icon
      { title: 'فرق التسويق', url: '/dashboard/user-mangment/marketer', icon: Megaphone },
      { title: 'إدارة السائقين', url: '/dashboard/user-mangment/drivers', icon: Truck },
  ...
  },
  {
    ...
    items: [
      { title: 'العروض الترويجية', url: '/dashboard/promotions', icon: Tag },
  ...
  },
  {
    ...
    items: [
      { title: 'تقارير الأداء', url: '/dashboard/reports', icon: Activity },
    ],
  },
  {
    label: 'المالية والمحاسبة',
    items: [
      { title: 'حركات المصروفات', url: '/dashboard/expenses', icon: CreditCard }, // Changed to "Expense Transactions"
    ],
  },
  {
    ...
    items: [
      { title: 'الإعدادات العامة', url: '/dashboard/settings', icon: Settings },
      { title: 'إدارة التنبيهات', url: '/dashboard/alerts', icon: Bell },
      { title: 'الدعم الفني', url: '/dashboard/maintinance', icon: LifeBuoy },
