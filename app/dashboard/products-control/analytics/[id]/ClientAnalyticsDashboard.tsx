          ...
          <>
            <div className='min-h-[300px] rounded-xl bg-card p-6 shadow'>
              <div className='mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5'>
                ...
                <div className='rounded-md border border-border p-4'>
                  <div className='mb-1 text-sm font-medium text-muted-foreground'>عدد الطلبات</div> {/* Corrected label */}
                  <div className='text-2xl font-bold text-foreground'>{analytics.totalOrders}</div>
                </div>
                <div className='rounded-md border border-border p-4'>
                  <div className='mb-1 text-sm font-medium text-muted-foreground'>عدد العملاء</div> {/* Corrected label */}
